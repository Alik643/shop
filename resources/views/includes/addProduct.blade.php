<div class="add-product-block popup">
    ...
    <div class="post-details">
        <form class="product-action-form" action="{{ route('products.store') }}" method="post">
            @csrf
            <label>
        ...
        <div class="product-attributes">
            ...
            <button type="submit" class="add-attr-btn">Добавить</button>
        </div>
    </div>
</div>
