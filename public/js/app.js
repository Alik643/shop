...
$(document).ready(function () {
  ...
  $(document).on('click', '.add-attr-btn', function (e) {
    ...
    var form = $('.add-product-block .product-action-form');
    form.submit();
  });
  $(document).on('click', '.edit-attr-btn', function (e) {
    var keyValuePairs = document.querySelectorAll('.edit-product-block .product-attributes > div');
    var data = {};
    keyValuePairs.forEach(function (pair) {
      var key = pair.querySelector('.key').value;
      var value = pair.querySelector('.value').value;
    ...
    var form = $('.edit-product-block .product-action-form');
    form.submit();
  });
  ...
  $(document).on('click', '.product-detail', function () {
    ...
    axios.get(window.productShow + "/" + id, {
      ...
      var attributes = JSON.parse(response.data.DATA);
      var dataString = '';
  ...
  $(document).on('click', '.edit-product', function () {
    var id = $(this).attr('data-id');
    $('.edit-product-block .product-action-form').attr('action', $('.edit-product-block .product-action-form').attr('action') + '/' + id);
    $('.edit-product-block input').each(function (e) {
      var name = $('.edit-product-block input')[e].getAttribute('name');
      if (productInfo[name]) $('.edit-product-block input')[e].value = productInfo[name];
    });
    var attributes = JSON.parse(productInfo['DATA']);
